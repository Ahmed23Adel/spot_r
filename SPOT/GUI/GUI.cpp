...
GUI::GUI()
{
	...
	changeMenuItemTo(ITM_COURSE_STATUS, "GUI\\Images\\Menu\\rightWrong.jpeg");
	changeMenuItemTo(ITM_ADD_GRADE, "GUI\\Images\\Menu\\Aplus.jpeg");
	changeMenuItemTo(ITM_SHOW_GRADE, "GUI\\Images\\Menu\\gpa.jpg");
	changeMenuItemTo(ITM_SUPPORT_MINOR, "GUI\\Images\\Menu\\books.jpeg");
